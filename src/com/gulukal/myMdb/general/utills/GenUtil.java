package com.gulukal.myMdb.general.utills;
...
public class GenUtil {
	...
	public static String encoderPassword(String password) {
		...
		String toEncodePassword = encoder.encodeToString(password.getBytes());
		return toEncodePassword;
	}

	// decode: Sifre Cozucu
	public static String decoderPassword(String encoderPassword) {

		Decoder decoder = Base64.getDecoder();
		String decodePassword = new String(decoder.decode(encoderPassword));
	...
	public static LocalTime readTime() {
		...
		do {
			try {
				...
				i = readInt("Lutfen saat bilgisini rakam olarak 1-24 arassinda giriniz.");
				n = readInt("Lutfen dakika bilgisini rakam olarak 1-59 arassinda giriniz.");
	...
	public static Map<String, Object> readBirth() {
		...
		String aDate = GenUtil.readString("Lutfen dogum tarihinizi (yyyy-mm-dd) formatinda giriniz:");
	...
	public static LocalDate readDate(String str) {
		...
		do {
			...
			try {
				...
				String aDate = GenUtil.readString(str + " tarihini (yyyy-mm-dd) formatinda giriniz:");
	...
	// kullanicidan String i Localdate e cevirme
	...
	// ana baslikli com.gulukal.myMdb.menu olusturma return int
	...
	// com.gulukal.myMdb.menu olusturma return int
	...
	// basit ara com.gulukal.myMdb.menu olusturma return int
	...
	// baslik ve com.gulukal.myMdb.menu icin cizgiler olusturma
	...
	// baslik ve com.gulukal.myMdb.menu icin print methodu
